...
namespace SBOCLASS.Models.EOA
{
    public class ReceiptFromProduction
    {
        ...
        public List<ReceiptFromProductionDetail> Lines = new List<ReceiptFromProductionDetail>();
    ...
    public class ReceiptFromProductionDetail
    {
        ...
        public string WMSTransId="";
        public string ReceiptType = "";         //C = Complete, R = Reject
        ...
        public bool Validate()
        {
            ...
            if (LineNo <= -1) throw new Exception($"Line {WMSTransId}. LineNo must be provided.");
            ...
            if (ReceiptType != "R" && ReceiptType !="C" && ReceiptType !="") throw new Exception($"Line {WMSTransId}. Invalid receipt type. Valid values are: C - Completed, R - Reject");
            UOM = UOM ?? "";
            //Return component must have baseline.
            //Receipt of finished good does not need baseline.
            //Receiptype if provided, to mark if the the receipt is reject or complete - default is complete
